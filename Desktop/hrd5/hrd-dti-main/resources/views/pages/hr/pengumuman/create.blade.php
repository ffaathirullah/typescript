            ...
            <div class="card card-custom gutter-b border-0 shadow">
              ...
              <div class="card-body bg-white">
                @if($errors->any())
                  ...
                  @endif
                  <form action="{{ route('pengumumanhr.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="col-md-3 col-12 p-5 rounded bg-white m-2">
                                    <div class="checkbox-inline d-flex">
                                        <label class="checkbox checkbox-outline checkbox-success">
                                            <input type="checkbox" name="pegawai_id[]" value="{{ $b->id }}">
                                            <span></span> {{ $b->nama }}
                                        </label>
                                    </div>
                                </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="ringkasan" id="ringkasan" class="form-control" value="{{ old('ringkasan') }}"> 
                      </div>
                      <div class="form-group">
