            ...
            <div class="card card-custom gutter-b border-0 shadow">
              <div class="card-header">
                <div class="card-title">
                  <h3 class="card-label text-gray-700">Show Data Client</h3>
                </div>
              </div>
                    ...
                    @csrf
                      <div class="form-group">
                        ...
                        <select name="user_id" id="user_id" class="form-control">
                            <option value="" disabled>--Tentukan account untuk Client--</option>
                            @foreach ($user as $u)
                                <option value="{{ $u->id }}" {{ old('user_id', $client->user_id) == $u->id ? 'selected' : '' }}>{{ $u->username }} - {{ $u->email }}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="row">
                          ...
                          <div class="col md-4">
                              <div class="form-group">
                                ...
                                <input type="text" name="kontak" id="kontak" class="form-control" value="{{ $client->kontak }}">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <textarea name="alamat" id="alamat" cols="30" rows="5" class="form-control">{{ $client->alamat }}</textarea>
                              </div>
                          </div>
                      </div>
                      <div class="form-group">
