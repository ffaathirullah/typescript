                    ...
                    <div class="row">
                      <div class="col-md-4 col-12">
                        <div class="form-group">
                          ...
                          <select name="pegawai_id" id="pegawai_id" class="form-control">
                              @foreach ($data as $d)
                                  <option value="{{ $d['id'] }}" {{ old('pegawai_id', $pinjaman->pegawai_id) == $d['id'] ? 'selected' : '' }}>{{ $d['nama'] }}</option>
                              @endforeach
                          </select>
                        </div>
                      </div>
                      <div class="col-md-8 col-12">
                        <div class="form-group">
                          ...
                          <input type="date" name="tanggal_pinjam" id="tanggal_pinjam" class="form-control" value="{{ $pinjaman->tanggal_pinjam }}"> 
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number" name="jumlah_pinjam" id="jumlah_pinjam" class="form-control" value="{{ $pinjaman->jumlah_pinjam }}"> 
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="angsuran">Angsuran:</label>
                            <input type="number" name="angsuran" id="angsuran" class="form-control" value="{{ $pinjaman->angsuran }}"> 
                          </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="alasan" id="alasan" class="form-control" value="{{ $pinjaman->alasan }}"> 
                          </div>
                        </div>
                    </div>
                    <div class="form-group">
