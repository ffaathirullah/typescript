                  ...
                  <div class="form bg-gray-300 p-5 shadow rounded">
                      <form action="{{ route('shift.update', $shift->id) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shift_name" id="shift_name" class="form-control" value="{{$shift->shift_name }}"> 
                          </div>
                          <div class="form-group">
                              ...
                              <div class="row">
                                ...
                                @for ($i = 0; $i < $d; $i++)
                                    <div class="col-md-4 col-6">
                                        <label>
                                            <input type="checkbox" name="hari_kerja[]" value="{{ $h }}" {{ (($dataku[$i] == $h )? 'checked' : '') }}> {{ $h }}
                                        </label>
                                    </div>
                                    @endfor
                                    @endforeach
