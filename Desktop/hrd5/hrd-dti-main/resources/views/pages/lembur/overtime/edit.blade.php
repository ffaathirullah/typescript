                      ...
                      <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="date" name="tanggal" id="tanggal" class="form-control" value="{{ $overtime->tanggal }}"> 
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="jam_masuk_lembur">Jam Mulai:</label>
                                <input type="time" name="jam_masuk_lembur" id="jam_masuk_lembur" class="form-control" value="{{ $overtime->jam_masuk_lembur }}"> 
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="jam_keluar_lembur">Jam Selesai:</label>
                                <input type="time" name="jam_keluar_lembur" id="jam_keluar_lembur" class="form-control" value="{{ $overtime->jam_keluar_lembur }}"> 
                            </div>
                        </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="pekerjaan" id="pekerjaan" class="form-control" value="{{ $overtime->pekerjaan }}" placeholder="Pekerjaan..."> 
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="uraian_pekerjaan" id="uraian_pekerjaan" cols="30" rows="10" class="form-control" placeholder="Uraian Pekerjaan..">{{ $overtime->uraian_pekerjaan }}</textarea>
                        </div>
                      </div>
                    </div>
                      <div class="form-group">
