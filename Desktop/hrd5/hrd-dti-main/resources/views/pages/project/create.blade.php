            ...
            <div class="card card-custom gutter-b border-0 shadow">
              <div class="card-header">
                <div class="card-title">
                  <h3 class="card-label text-gray-700">Add Data Project</h3>
                </div>
              </div>
                      ...
                      <div class="row">
                          <div class="col-md-8">
                              <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control bg-success-o-40" value="{{ old('title') }}">
                              </div>
                          </div>
                          <div class="col md-4">
                              <div class="form-group">
                                ...
                                <select name="prioritas" id="prioritas" class="form-control bg-success-o-40 text-center">
                                  <option value="" disabled selected class="bg-danger-o-10">--Tentukan Client Project--</option>
                      ...
                      <div class="row">
                          <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <input type="date" name="start_date" id="start_date" class="form-control bg-success-o-40" value="{{ old('start_date') }}">
                              </div>
                          </div>
                          <div class="col-md-4">
                              <div class="form-group">
                                <label for="end_date">End Date:</label>
                                <input type="date" name="end_date" id="end_date" class="form-control bg-success-o-40" value="{{ old('end_date') }}">
                              </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="status_project" id="status_project" class="form-control bg-success-o-40 text-center">
                                  <option value="" disabled selected class="bg-info-o-10">--Tentukan Status Project--</option>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea name="ringkasan_project" id="ringkasan_project" cols="30" rows="3" class="form-control bg-success-o-40">{{ old('ringkasan_project') }}</textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea name="description" id="description" cols="30" rows="3" class="form-control bg-success-o-40">{{ old('description') }}</textarea>
                          </div>
                        </div>
                      </div>
                      <div class="row">
