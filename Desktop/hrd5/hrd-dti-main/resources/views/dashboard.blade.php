...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$pesertadaftar}}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Peserta Terdaftar (Hari Ini)</div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Peserta Terverifikasi</div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$pesertaSudahVerifikasi}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Peserta Belum Terverifikasi</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$pesertaBelumVerifikasi}}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-3">
        <h3 class="h3 mb-0 text-gray-800">Peserta Terbatu</h3>
    </div>

    <!-- Content Row -->
    <div class="row">
        <div class="col-md-12">
            <div class="box box-widget border-left-primary shadow-sm bg-white rounded p-3 mb-5">
                <div class="box-body">
                    <table class="table table-responsive">
                        ...
                        <tbody>
                            @php $index = 1; @endphp @foreach ($peserta as $pes)
                            <tr>
                                <td>{{ $index++ }}</td>
